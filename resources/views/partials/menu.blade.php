<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('my_project_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.my-projects.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/my-projects") || request()->is("admin/my-projects/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-chalkboard-teacher c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.myProject.title') }}
                </a>
            </li>
        @endcan
        @can('thread_access')
