...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // My Projects
    Route::delete('my-projects/destroy', 'MyProjectsController@massDestroy')->name('my-projects.massDestroy');
    Route::post('my-projects/media', 'MyProjectsController@storeMedia')->name('my-projects.storeMedia');
    Route::post('my-projects/ckmedia', 'MyProjectsController@storeCKEditorImages')->name('my-projects.storeCKEditorImages');
    Route::resource('my-projects', 'MyProjectsController');

    // Threads
    Route::delete('threads/destroy', 'ThreadsController@massDestroy')->name('threads.massDestroy');
    Route::post('threads/media', 'ThreadsController@storeMedia')->name('threads.storeMedia');
    Route::post('threads/ckmedia', 'ThreadsController@storeCKEditorImages')->name('threads.storeCKEditorImages');
